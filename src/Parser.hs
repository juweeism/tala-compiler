...
happyExpList = Happy_Data_Array.listArray (0,8) ([8224,16,64,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parser","Exp","\"=\"","var","str","%eof"]
...
happyReduction_1 (HappyTerminal (Tok_Str happy_var_3))
	_
...
happyNewToken action sts stk (tk:tks) =
	...
	Tok_Str happy_dollar_dollar -> cont 7;
	_ -> happyError' ((tk:tks), [])
	}
